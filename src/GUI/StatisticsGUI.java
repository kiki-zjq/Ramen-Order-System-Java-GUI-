...
import Control.ControlStatistics;
...
public class StatisticsGUI extends JFrame{
	...
	private void initialize() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ControlStatistics controlStatistics = new ControlStatistics();
				mostPopMeal = controlStatistics.getSelfMost(statistics, );
				}
			});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ControlStatistics controlStatistics = new ControlStatistics();
				//System.out.println((String)comboBox.getSelectedItem()+"  "+mostPopMeal.getName()+"  "+mostPopMeal.getValue()+ "  "+Integer.toString(mostPopMeal.getValue()));
				mostPopMeal = controlStatistics.getSelfMost(statistics, (String)comboBox.getSelectedItem());
				//System.out.println((String)comboBox.getSelectedItem()+"  "+mostPopMeal.getName()+"  "+mostPopMeal.getValue()+ "  "+Integer.toString(mostPopMeal.getValue()));
