...
public class Registered extends JFrame{
	...
	private void initialize() {
		...
		textField_4.setBounds(455, 342, 83, 33);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				customer = controlCustomer.chkCustomer(customer);
				...
				if(customer.getJudgeCode().equals("000"))  {
					...
					try {
						customer = customerDao.chkExist(customer);
					...
					if(customer.getJudgeCode().equals("000")){
						...
						try {
							customer = customerDao.setCustomerMsg(customer);
							if(customer.getUid().isEmpty() || customerDao.saveCustomer(customer) == 0){
