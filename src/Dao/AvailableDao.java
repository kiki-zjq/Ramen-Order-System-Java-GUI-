...
public class AvailableDao {
    ...
    public Available getAvailableMsg() throws IOException {
        ...
        if (!file.exists()) {
            ...
            if (!file.createNewFile()) {
                ...
                bufferedWriter2.write("bamboo " + "true" + "\r\n");
        ...
        if (StringList.size() == 0) {
            ...
            available.setBamboo(StringList.get(11));
    ...
    public int setAvailable(Available available) throws IOException {
        ...
        bufferedWriter2.write("bamboo " + available.getBamboo() + "\r\n");
        bufferedWriter2.flush();
        bufferedWriter2.close();
        return 1;
    }
    ...
    public Available changeState(Available available, String name, String state) throws IOException {
        ...
        if(name.equals("Bamboo_Shoots")) available.setBamboo(state);
        if(name.equals("Extra_Boiled_Egg")) available.setBoiledEgg(state);
        if(name.equals("Extra_Chashu")) available.setChashu(state);
        if(name.equals("Extra_Nori")) available.setNori(state);
        return available;
    }
    ...
    public String searchState(Available available, String name) throws IOException {
        ...
        if(name.equals("Extra_Boiled_Egg")) return StringList.get(9);
        if(name.equals("Extra_Chashu")) return StringList.get(8);
        if(name.equals("Extra_Nori")) return StringList.get(7);
        return "";
    }
}